...
AFormationHichamCharacter::AFormationHichamCharacter()
{
...
void AFormationHichamCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AFormationHichamCharacter::Move);
...
void AFormationHichamCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AFormationHichamCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
